...
// Campana: notificaciones activadas
...
// Campana tachada: notificaciones apagadas / bloqueadas / no disponibles
export function IconCampanaOff() {
  return (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M13.7 21a2 2 0 0 1-3.4 0" />
      <path d="M18.6 13c-.4-1.5-.6-3.2-.6-5a6 6 0 0 0-9.3-5" />
