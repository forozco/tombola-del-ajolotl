...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      {/* Vercel Web Analytics: script sin UI que reporta pageviews + custom
          events al dashboard del deployment. Solo se activa en producción
          (en dev quedan console.log). Cero PII y respeta DNT/GPC. */}
      <Analytics />
    </div>
  )
}
